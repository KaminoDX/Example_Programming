...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 20. Jun 2023 um 11:46
...
--
-- Datenbank: `db_lap_rechnungslegung`
--
...
CREATE TABLE `tbl_zahlungsarten` (
  ...
  `AufpreisExkl` decimal(4,2) UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_zahlungsarten` (`IDZahlungsart`, `Zahlungsart`, `AufpreisExkl`) VALUES
(1, 'Vorauskasse', '0.00'),
(2, 'Paypal', '3.50');
